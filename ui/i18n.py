...
I18N_MAP = {
    "zh": {
        ...
        "settings_wfp_dns_exemption": "严格路由下允许 HypoMux 上游 DNS",
        "settings_wfp_dns_exemption_hint": "仅临时放行 HypoMux 已绑定网卡的 TCP/UDP 53，其他程序仍受严格路由保护。建议保持开启。",
    ...
    "en": {
        ...
        "settings_wfp_dns_exemption": "Allow HypoMux upstream DNS under strict route",
        "settings_wfp_dns_exemption_hint": "Temporarily permits only HypoMux's bound TCP/UDP port 53 sockets; all other apps remain protected by strict routing. Keep enabled.",
