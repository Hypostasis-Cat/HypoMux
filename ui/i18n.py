...
I18N_MAP = {
    "zh": {
        ...
        "about_update_available_content": "当前版本：v{current}\n最新版本：v{latest}\n\n更新说明：\n{notes}\n\n立即更新会从 HypoMux 的 GitHub Release 下载官方安装包，下载完成后将关闭程序并自动安装。",
        "about_update_notes_empty": "此版本暂无更新说明。",
        "about_update_now": "立即更新",
        "about_update_later": "稍后",
        "about_update_downloading": "正在下载更新… {percent}%",
        "about_update_installing": "下载完成，正在退出并启动安装程序…",
    ...
    "en": {
        ...
        "about_update_available_content": "Current version: v{current}\nLatest version: v{latest}\n\nWhat's new:\n{notes}\n\nUpdate now downloads the official installer from HypoMux's GitHub Release, then exits and installs automatically.",
        ...
        "about_update_installing": "Download complete. Exiting to start the installer…",
