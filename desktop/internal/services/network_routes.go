...
var tunnelNamePattern = regexp.MustCompile(`(?i)(\b(tun|tunnel|tap|vpn)\b|wintun|wireguard|tailscale|mihomo|clash|famatech radmin)`)
...
func (r networkRoute) tunnel() bool {
	...
	return r.InterfaceType == 131 || tunnelNamePattern.MatchString(r.Alias+" "+r.Description)
}
