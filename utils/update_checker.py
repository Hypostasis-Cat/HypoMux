...
def launch_installer_after_exit(installer_path: str, process_id: int) -> None:
    ...
    # asset name.  The helper waits until HypoMux has completed its normal
    # network cleanup before opening the interactive Inno Setup wizard.
    ...
    subprocess.Popen(
        ...
        # A normal child process survives this GUI process and remains hidden.
