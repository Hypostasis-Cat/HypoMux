...
from engine_client.tun_contract import (
    DNS_HEALTH_FAILURE_LIMIT as CONTRACT_DNS_HEALTH_FAILURE_LIMIT,
    DNS_HEALTH_INTERVAL as CONTRACT_DNS_HEALTH_INTERVAL,
    DNS_MODE_DOH_STRICT as CONTRACT_DNS_MODE_DOH_STRICT,
    DNS_MODE_LEGACY_COMPAT as CONTRACT_DNS_MODE_LEGACY_COMPAT,
)
from proxy_worker import MultiPortProxyWorker


class TunDnsPlanner:
    DNS_MODE_DOH_STRICT = CONTRACT_DNS_MODE_DOH_STRICT
    DNS_MODE_LEGACY_COMPAT = CONTRACT_DNS_MODE_LEGACY_COMPAT
    DNS_HEALTH_INTERVAL = CONTRACT_DNS_HEALTH_INTERVAL
    DNS_HEALTH_FAILURE_LIMIT = CONTRACT_DNS_HEALTH_FAILURE_LIMIT
